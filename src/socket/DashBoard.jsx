...
const Img1 = "https://th.bing.com/th/id/OIP.xzEfxebz8eYFAhsRiiGNegHaHa?rs=1&pid=ImgDetMain";
const tutorialsdev = "https://th.bing.com/th/id/OIP.xzEfxebz8eYFAhsRiiGNegHaHa?rs=1&pid=ImgDetMain";
                ...
                <div>
                    {
                        users.length > 0 ?
                            users.map(({ userId, user }) => {
                                return (
                                    <div className='flex items-center py-8 border-b border-b-gray-300' onClick={() => fetchMessages('new', user)}>
                                        <div className='cursor-pointer flex items-center'>
                                            <div><img src={Img1} className="w-[60px] h-[60px] rounded-full p-[2px] border border-primary" /></div>
                                            <div className='ml-6'>
                                                <h3 className='text-lg font-semibold'>{user?.fullName}</h3>
