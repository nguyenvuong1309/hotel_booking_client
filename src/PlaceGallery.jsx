...
export default function PlaceGallery({ place }) {
    ...
    if (showAllPhotos) {
        return (
            <div className="inset-0 bg-white text-white min-w-full min-h-screen">
    ...
    return (
        <div className="flex justify-center w-11/12">
                        ...
                        {place.photos?.[0] && (
                            <div className="">
                                <img
                                    ...
                                    className="aspect-square cursor-pointer object-cover w-[400px] h-[288px]"
            ...
            <button onClick={() => setShowAllPhotos(true)}
                className="flex absolute  py-2 px-4 bg-white rounded-2xl  shadow-md shadow-gray-500">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
