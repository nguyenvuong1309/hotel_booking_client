        ...
        <div className="justify-center flex">
            <div className="w-9/12">
                <div className="grid gap-2 grid-cols-[2fr_1fr_1fr_1fr]">
                    <div className="w-[400px] h-[288px]">
                        {place.photos?.[0] && (
                            <div>
                                <img onClick={() => setShowAllPhotos(true)} className="aspect-square cursor-pointer object-cover w-[400px] h-[288px]"
                    ...
                    <div className="grid gap-2">
                        <div className="w-[210px] h-[140px]">
                            {place.photos?.[1] && (
                                <img onClick={() => setShowAllPhotos(true)}
                                    className="aspect-square cursor-pointer  object-cover w-[210px] h-[140px]"
                        ...
                        <div className="w-[210px] h-[140px]">
                            {place.photos?.[2] && (
                                <img onClick={() => setShowAllPhotos(true)}
                                    className="aspect-square cursor-pointer  object-cover relative w-[210px] h-[140px]"
                    ...
                    <div className="w-[210px] h-[140px] grid gap-2">
                        <div>
                            {place.photos?.[3] && (
                                <img onClick={() => setShowAllPhotos(true)}
                                    className="aspect-square cursor-pointer  object-cover w-[210px] h-[140px]"
            ...
            <button onClick={() => setShowAllPhotos(true)} className=" flex absolute bottom-2 right-2 py-2 px-4 bg-white rounded-2xl shadow shadow-md shadow-gray-500">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
