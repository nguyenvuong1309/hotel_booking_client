    ...
    return (
        <>
            <div className="flex flex-wrap gap-2 mt-2">
                ...
                <button onClick={addPhotoByLink} className="border border-gray-700 text-white px-4 rounded-md" style={{ backgroundColor: '#F5385D' }}>Add photo</button>
            </div>
            <div className="mt-2 gap-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
                ...
                <label className="cursor-pointer flex gap-1 items-center justify-center border bg-transparent rounded-xl text-xl text-black">                    <input type="file" multiple className="hidden" onChange={uploadPhoto} />
