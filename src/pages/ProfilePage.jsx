                                        ...
                                        <div className="flex flex-wrap justify-center">
                                            <div className="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
                                                <div className="relative">
                                                    <img alt="..." src="https://i.pinimg.com/550x/0c/11/82/0c1182d5b237ea83402f66b08d1a18af.jpg" className="shadow-xl rounded-full h-auto align-middle border-none absolute -m-16 -ml-20 lg:-ml-16 max-w-150-px" />
                                                </div>
                                            </div>
                                                    ...
                                                    <div>
                                                        {isEditPage === true ? (
                                                            <a href="#pablo" className="font-normal text-pink-500"
                                                                onClick={(ev) => { setIsEditPage(false) }}
                                                            >Edit</a>
                                                        ) : (
                                                            <a onClick={(ev) => { updateUser() }} className="font-normal text-pink-500">Save</a>
                                                        )}
                                                    </div>
                                                </div>
                                            </div>
