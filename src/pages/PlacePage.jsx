...
export default function PlacePage() {
    ...
    return (
        <div className="mt-4 bg-gray-100 -mx-8 px-8 pt-8 grid">
            ...
            <div className="flex justify-center mt-2">
                <div className="w-9/12 border border-slate-400 grid grid-cols-2 justify-between gap-10">
                    {temp?.length > 0 ? temp.map((item) => (
                        <Link to={`/single-room/${item?.fields?.slug}`}>
