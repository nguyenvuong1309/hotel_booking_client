...
const UsersTable = () => {
  ...
  const [navigateToEditUser, setNavigateToEditUser] = useState(false);
  ...
  return (
    <div className="relative overflow-x-auto shadow-md sm:rounded-lg w-full h-full bg-gray-900">
      <div className="flex m-2  items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-black dark:bg-gray-900">
        <div>
          ...
          {data && data.length > 0 && data.map(user => (
            <tr key={user._id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <th scope="row" className="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                <img className="w-10 h-10 rounded-full" src="https://i.pinimg.com/564x/06/88/8e/06888e665da5fc28bdac697bee700fc0.jpg" alt="Jese image" />
                <div className="ps-3">
